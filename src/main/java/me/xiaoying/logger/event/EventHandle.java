...
public class EventHandle {
    ...
    public static void registerEvent(Listener listener) {
        ...
        registeredListeners.add(new RegisteredListener(listener, methods));
    }
    ...
    public static void unregisterEvent(Listener listener) {
        Iterator<RegisteredListener> registeredListenerIterator = registeredListeners.iterator();
    ...
    public static void callEvent(Event event) {
        registeredListeners.forEach(registeredListener -> {
            registeredListener.getMethods().forEach(method -> {
